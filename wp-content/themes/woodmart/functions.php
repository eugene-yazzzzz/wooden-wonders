...
add_action('woocommerce_product_query', 'exclude_products_in_category');

function exclude_products_in_category($q)
{
	// Проверяем, является ли текущая страница категорией 'not-show'
	$tax_query = (array) $q->get('tax_query');

	// Добавляем условие исключения товаров из категории 'not-show'
	$tax_query[] = array(
		'taxonomy' => 'product_cat',
		'field'    => 'slug',
		'terms'    => array('not-show'),
		'operator' => 'NOT IN',
	);
